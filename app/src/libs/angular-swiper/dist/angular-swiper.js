        ...
        return {
            ...
            controller: function($scope, $element, $timeout) {
                ...
                var params = {
                    ...
                    calculateHeight: $scope.calculateHeight || false,
                    calculateOnInit: $scope.calculateOnInit || false,
                    childElementToCalculate: $scope.childElementToCalculate || undefined,
				...
				if ($scope.calculateHeight === true  && $scope.childElementToCalculate!==undefined ) {
                    params = angular.extend({}, params, {
                        calculateHeight: $scope.calculateHeight,
                        childElementToCalculate: $scope.childElementToCalculate,
						calculateOnInit:$scope.calculateOnInit
                    });
                }
