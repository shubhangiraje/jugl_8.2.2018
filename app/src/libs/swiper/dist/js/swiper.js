...
(function () {
    ...
    var Swiper = function (container, params) {
        ...
        s.update = function (updateTranslate) {
			...
			if (s.params.calculateHeight && s.params.childElementToCalculate){
			    s.calculateHeights();
			}
			
        };
		
		s.calculateHeights = function () {
			var highest = null;
			var hi = 0;			
			$(s.params.childElementToCalculate).each(function(){  
			...
			if(highest!=null){
				$(s.wrapper).find(s.params.childElementToCalculate).css('height',highest.height()+'px');
			}	
		}
