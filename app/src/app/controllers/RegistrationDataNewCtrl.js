app.controller('RegistrationDataNewCtrl', function ($scope,$timeout,modal,jsonPostDataPromise,auth,status) {
    ...
    if (!$scope.data) {
        ...
        $scope.data.onShow=function(kendoEvent) {
            ...
            $scope.data.user.code = kendoEvent.view.params.code;
        };
        ...
        $scope.data.save = function() {
            $timeout(function(){
                ...
                jsonPostDataPromise('/ext-api-registration/data-new', {user: $scope.data.user})
                    .then(function (res) {
                        if (res.result) {
