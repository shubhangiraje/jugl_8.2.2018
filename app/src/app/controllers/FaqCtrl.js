app.controller('FaqCtrl', function ($scope, jsonDataPromise, $rootScope, $timeout) {
    ...
    if (!$scope.data) {
        ...
        $scope.data.onShow = function(kendoEvent) {
            ...
            if(kendoEvent.view.params.id) {
                $scope.data.faqId = kendoEvent.view.params.id;
            }
        };
        ...
        $scope.data.log.load = function() {
            ...
            jsonDataPromise('/ext-api-faq/list', {
                ...
                .then(function (res) {
                    ...
                    if($scope.data.faqId) {
                        $timeout(function() {
                            ...
                            var scrollTo = $('#faq'+$scope.data.faqId).position().top;
