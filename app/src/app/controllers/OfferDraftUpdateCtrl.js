app.controller('OfferDraftUpdateCtrl', function ($scope,jsonDataPromise,jsonPostDataPromise,$interval,$timeout,modal,$rootScope,uploadService,gettextCatalog,$log,$cordovaCamera) {
    ...
    if (!$scope.data) {
        ...
        $scope.data.onShow = function(kendoEvent) {
            ...
            $timeout(function(){
                ...
                jsonDataPromise('/ext-api-offer-draft/get', {id: $scope.data.draft_id, ids: ids})
                    .then(function (res) {
                        ...
                        intervalSaveDraft=$interval(function(){
                            if($scope.data.isSaveDraft) {
                                jsonPostDataPromise('/ext-api-offer-draft/update', {id: $scope.data.draft_id, offer: $scope.data.offer}).then(function (res) {});
        ...
        $scope.data.addInterests = function() {
            ...
            kendo.mobile.application.navigate('view-interests-addstep1.html?type=updateDraftOffer&draft_id='+$scope.data.draft_id);
        };
                ...
                jsonPostDataPromise('/ext-api-offer/preview', {offer: $scope.data.offer})
                    .then(function (res) {
                        if(res.result) {
                            ...
                            kendo.mobile.application.navigate('view-offers-preview.html?draft_id='+$scope.data.draft_id);
                            kendo.mobile.application.hideLoading();
                        } else {
